...
heroText: alun's blog
tagline: Java+Web+iOS+运维 技术积累。
# actionText: 立刻进入 →
# actionLink: /web/
...
features: # 可选的
- title: Java
  details: Spring、SpringBoot、Mysql框架等后端技术
  link: /java/ # 可选
  imgUrl: /img/web.png # 可选
- title: Web
  details: Vue/uniApp，前端页面相关技术
  link: /ui/
  imgUrl: /img/ui.png
- title: 运维
...
### 📚Blog
这是一个兼具博客文章、知识管理、文档查找的个人网站，主要内容是Java+前端+运维+iOS技术。
